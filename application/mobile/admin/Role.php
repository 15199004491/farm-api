...
class Role extends Admin
{
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($role = RoleModel::create($data)) {
                // 记录行为
                action_log('role_add', 'mobile_role', $role['id'], UID, $data['name']);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (RoleModel::update($data)) {
                ...
                role_auth();
                // 记录行为
                action_log('role_edit', 'mobile_role', $id, UID, $data['name']);
    ...
    public function setStatus($type = '', $record = [])
    {
        ...
        foreach ($ids as $id) {
            ...
            action_log('role_'.$type, 'mobile_role', $id, UID);
        }
    ...
    public function quickEdit($record = [])
    {
        ...
        return parent::quickEdit(['role_edit', 'mobile_role', $id, UID, $details]);
    }
}
