...
-- ----------------------------
-- Table structure for dp_mobile_message
-- ----------------------------
...
-- ----------------------------
-- Table structure for `dp_mobile_role`
-- ----------------------------
DROP TABLE IF EXISTS `dp_mobile_role`;
CREATE TABLE `dp_mobile_role` (
...
-- ----------------------------
-- Records of dp_mobile_role
-- ----------------------------
INSERT INTO `dp_mobile_role` VALUES ('1', '0', '超级管理员', '系统默认创建的角色，拥有最高权限', '', '0', '1476270000', '1468117612', '1', '1', '0');
...
CREATE TABLE `dp_admin_user` (
  ...
  `admin_bind` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否绑定手机号码',
